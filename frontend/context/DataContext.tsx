...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <DataContext.Provider value={{
            ...
            startPolling,
            stopPolling,
            customerPayments: (sales as any)?.customerPayments || [],
            companyConfig: auth.companyConfig,
            sales: (sales as any)?.sales || [],
            tasks,
            workOrders: (production as any)?.workOrders || [],
            recurringInvoices: (finance as any)?.recurringInvoices || [],
            invoices: (finance as any)?.invoices || [],
            filteredLedger: (finance as any)?.ledger || [],
            accounts: (finance as any)?.accounts || [],
            filteredInvoices: (finance as any)?.invoices || [],
            alerts: auth.alerts,
